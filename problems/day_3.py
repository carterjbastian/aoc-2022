...
def part_1():
    ...
    for rucksack in input_arr:
        ...
        compartment1 = { ord(c) - 64 + 26 if c.isupper() else ord(c) - 96 for c in rucksack[0:divider] }
        compartment2 = { ord(c) - 64 + 26 if c.isupper() else ord(c) - 96 for c in rucksack[divider:] }
...
def part_2():
    ...
    for idx, rucksack in enumerate(input_arr):
        compartment = { ord(c) - 64 + 26 if c.isupper() else ord(c) - 96 for c in rucksack }
